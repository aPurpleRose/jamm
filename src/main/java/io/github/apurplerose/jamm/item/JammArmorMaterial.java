...
public enum JammArmorMaterial implements ArmorMaterial {
         ...
         */
        AMETHYST("amethyst",27, new int[]{2,5,7,2}, 27, SoundEvents.ITEM_ARMOR_EQUIP_GOLD,
                1.0f, 0.0f, () -> Ingredient.ofItems(JammItems.AMETHYST)),
        DARK_AMETHYST("dark_amethyst",35, new int[]{3,6,8,3}, 35, SoundEvents.ITEM_ARMOR_EQUIP_GOLD,
                2.5f, 0.05f, () -> Ingredient.ofItems(JammItems.DARK_AMETHYST)),
        ...
        private JammArmorMaterial(String name, int durabilityMultiplier, int[] protectionAmounts, int enchantability, SoundEvent equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredientSupplier) {
                this.name = name;
