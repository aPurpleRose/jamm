...
public enum JammToolMaterial implements ToolMaterial {
        ...
        AMETHYST(MiningLevels.IRON, 750, 7, 2.5f, 22, Ingredient.ofItems(JammItems.AMETHYST)),//7f, 2.5f
        DARK_AMETHYST(MiningLevels.DIAMOND, 1750, 8, 3.5f, 27, Ingredient.ofItems(JammItems.DARK_AMETHYST));//8f, 3f
