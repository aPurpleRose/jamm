...
public enum JammToolMaterial implements ToolMaterial {
    ...
    AMETHYST(MiningLevels.IRON, 750, 7.0F, 2.5F, 22, () -> {
        return Ingredient.ofItems(Items.IRON_INGOT);
    });
    ...
    private JammToolMaterial(int miningLevel, int itemDurability, float miningSpeed, float attackDamage, int enchantability, Supplier<Ingredient> repairIngredient) {
